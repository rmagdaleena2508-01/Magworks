...
| Intro animation | **GSAP** + **TextPlugin** (CDN) — typed first line, slide/fade second line, then fade the black overlay; session-once, skippable, off for reduced-motion |
